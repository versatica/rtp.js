...
describe('parse RTP packet 1', () => {
    ...
    test('packet processing succeeds', () => {
        packet = new RtpPacket_1.RtpPacket(buffer);
...
describe('create RTP packet 5 from scratch', () => {
    ...
    test('packet processing succeeds', () => {
        ...
        expect(packet).toBeDefined();
        expect(RtpPacket_1.isRtp(packet.getBuffer())).toBe(true);
        expect(packet.getVersion()).toBe(2);
...
describe('create RTP packet 8 from scratch', () => {
    ...
    test('packet processing succeeds', () => {
        ...
        expect(() => packet.padTo4Bytes()).toThrow(errors_1.InvalidStateError);
        packet.serialize();
