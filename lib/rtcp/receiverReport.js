...
class ReceiverReportPacket extends packet_1.RtcpPacket {
    ...
    constructor(buffer) {
        ...
        if (paddingFlag) {
            ...
            this.padding = buffer.readUInt8(((packet_1.RtcpPacket.getLength(buffer) * 4) + 4 - 1));
        }
        let count = packet_1.RtcpPacket.getCount(buffer);
        ...
        this.buffer = buffer.slice(undefined, FIXED_HEADER_LENGTH + (this.reports.length * REPORT_LENGTH));
    }
    /**
     * @ignore
     */
