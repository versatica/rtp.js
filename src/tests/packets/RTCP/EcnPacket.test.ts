...
const array = new Uint8Array(
	[
		0x88, 0xcd, 0x00, 0x07, // FMT: 8 (ECN), Type: 205 (RTPFB), Length: 7
		0x11, 0x22, 0x33, 0x44, // Sender SSRC: 0x11223344
		0x55, 0x66, 0x77, 0x88, // Media SSRC: 0x55667788
		0x00, 0x11, 0x00, 0x11, // Extended Highest Sequence Number
		0x23, 0x32, 0x45, 0x55, // ECT (0) Counter
		0x55, 0x44, 0x11, 0x00, // ECT (1) Counter
		0x22, 0x22, 0x33, 0x33, // ECN-CE Counter, not-ECT Counter
