...
const array = new Uint8Array(
	[
		0x83, 0xce, 0x00, 0x05, // FMT: 3 (RPSI), Type: 206 (PSFB), Length: 5
		0x11, 0x22, 0x33, 0x44, // Sender SSRC: 0x11223344
		0x55, 0x66, 0x77, 0x88, // Media SSRC: 0x55667788
		0x10, 0x78, 0x11, 0x22, // PB: 16, Payload Type: 120, Bit String
		0x33, 0x44, 0x55, 0x66, // Bit String
...
describe('parse RTCP RPSI packet', () =>
{
	...
	test('packet processing succeeds', () =>
	{
		...
		expect(
			areDataViewsEqual(clonedPacket.getBitString(), bitStringView)
		).toBe(true);
	});
});
...
describe('create RTCP RPSI packet', () =>
{
	...
	test('packet processing succeeds', () =>
	{
		...
		packet.setBitString(numericArrayToDataView(
